...
// Version 3 keeps its own save. The first time it runs it starts from the
// Version 2 save, so progress carries over; after that the two never touch.
const KEY = 'ashfall.v3.save';
