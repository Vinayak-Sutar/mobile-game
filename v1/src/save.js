...
// Version 1 keeps its own save, separate from Version 2's. The first time it
// runs it starts from the save both versions used to share, so progress made
// before the split carries over — after that the two never touch.
const KEY = 'ashfall.classic.save';
const SEED_KEY = 'ashfall.save.v1';
